...
const StatisticsView = () => {
  ...
  if (isLoading) {
    return <p className="statistics-loading">İstatistikler yükleniyor...</p>;
  } 
  ...
  if (isError) {
    return (
      <p className="statistics-error">
        Hata oluştu: İstatistik verileri çekilemedi.
      </p>
    );
  }
    ...
    <div className="dashboard-card statistics-view-main">
      ...
      {!hasData && (
        <p className="no-data-message">
          Seçilen dönem ({selectedMonth.label} {selectedYear.value}) için henüz
          gider işlemi bulunmamaktadır.
        </p>
      )}
      {hasData && (
